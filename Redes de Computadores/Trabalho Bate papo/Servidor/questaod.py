...
while 1:
  ...
  capitalizedSentence = raw_input('Digite a mensagem: ') # converte em letras maiusculas
  print ('Cliente %s enviou: %s, Servidor mandou: %s' % (addr, sentence, capitalizedSentence))
